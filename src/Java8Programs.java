...
public class Java8Programs {
	...
	public static void main(String[] args) {
		...
		Map<String, Long> occurances = Arrays.stream(str.split(""))
				.collect(Collectors.groupingBy(Function.identity(), Collectors.counting()));
		System.out.println("Occurances of each character from:" + str + ":is--->" + occurances);
...
//		System.out.println("Second Highest number from Numbers list:" + secondHighestnum);
		...
		String longestString = Arrays.stream(sentence.split(" ")).reduce((word1,word2)->(word1.length()>word2.length())?word1:word2).get();
